...
class DropRun extends qinpel_cps_1.QinColumn {
    constructor() {
        super();
        this._qinExplorer = new qinpel_cps_1.QinFileView();
        this._qinUp = new qinpel_cps_1.QinButton({ icon: new qinpel_cps_1.QinIcon(qinpel_cps_1.QinAsset.FaceArrowUp) });
        this._qinFolder = new qinpel_cps_1.QinString();
        this._qinDrop = new qinpel_cps_1.QinButton({ icon: new qinpel_cps_1.QinIcon(qinpel_cps_1.QinAsset.FaceArrowDown) });
        this._qinFind = new qinpel_cps_1.QinLine({ items: [this._qinUp, this._qinFolder, this._qinDrop] });
        this._qinCommands = new qinpel_cps_1.QinCombo();
        this._qinParameters = new qinpel_cps_1.QinString();
        this._qinWildcard = new qinpel_cps_1.QinButton({ icon: new qinpel_cps_1.QinIcon(qinpel_cps_1.QinAsset.FaceCog) });
        this._qinMount = new qinpel_cps_1.QinLine({
            items: [this._qinCommands, this._qinParameters, this._qinWildcard],
        });
        this._qinTokens = new qinpel_cps_1.QinCombo();
        this._qinAsk = new qinpel_cps_1.QinButton({ icon: new qinpel_cps_1.QinIcon(qinpel_cps_1.QinAsset.FaceEye) });
        this._qinRunning = new qinpel_cps_1.QinLine({ items: [this._qinTokens, this._qinAsk] });
        this.initExplorer();
        this.initFind();
        this.initMount();
        this.initRunning();
    ...
    dropSelectedAndRun() {
        ...
        let parameters = qinpel_res_1.QinSoul.body.parseParameters(this._qinParameters.value);
