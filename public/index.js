...
class DropRun extends qinpel_cps_1.QinColumn {
    constructor() {
        ...
        this._qinIssued = new qinpel_cps_1.QinCombo();
        this._qinAsk = new qinpel_cps_1.QinButton({ icon: new qinpel_cps_1.QinIcon(qinpel_cps_1.QinAsset.FaceEye) });
        this._qinRunning = new qinpel_cps_1.QinLine({ items: [this._qinIssued, this._qinAsk] });
        this.initExplorer();
        this.initFind();
        this.initMount();
        this.initRunning();
    ...
    dropSelectedAndRun() {
        ...
        const parameters = qinpel_res_1.QinBody.parseParameters(this._qinParameters.value);
